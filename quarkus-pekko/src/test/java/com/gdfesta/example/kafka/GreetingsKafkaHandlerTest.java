...
class GreetingsKafkaHandlerTest {
    ...
    void testMultipleGreetingsPublishMultipleMessages() {
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                long aliceCount = messages
                    .stream()
                    .filter(
                        msg ->
                            msg instanceof GreetingKafkaMessage.Greeted(String name) &&
                            name.equals(alice)
                    )
                    .count();
                long bobCount = messages
                    .stream()
                    .filter(
                        msg ->
                            msg instanceof GreetingKafkaMessage.Greeted(String name) &&
    ...
    void testRapidSuccessiveGreetingsPublishAll() {
        ...
        await()
            ...
            .untilAsserted(() -> {
                long count = TestKafkaConsumer.getMessages()
                    .stream()
                    .filter(
                        msg ->
                            msg instanceof GreetingKafkaMessage.Greeted(String name1) &&
    ...
    void testOnlySuccessfulGreetingsPublishToKafka() {
        ...
        long count = TestKafkaConsumer.getMessages()
            ...
            .filter(
                msg ->
                    msg instanceof GreetingKafkaMessage.Greeted(String name1) && name1.equals(name)
            )
            .count();
